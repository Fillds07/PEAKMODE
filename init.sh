...
echo -e "1. Configure network:     ${BOLD}./add-IP.sh${RESET}"
echo -e "2. Install dependencies:  ${BOLD}./install.sh${RESET}"
echo -e "3. Start the backend:     ${BOLD}./run-backend.sh${RESET}"
echo -e "4. Start the frontend:    ${BOLD}./run-frontend.sh${RESET}"
echo -e "5. View database:         ${BOLD}./print-db.sh${RESET}"
echo "" 