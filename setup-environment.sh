...
echo -e "${GREEN}=== PEAKMODE - Environment Setup ===${NC}"
...
chmod +x install-dependencies.sh start-backend.sh start-frontend.sh start-backend-tunnel.sh
...
echo -e "\n${GREEN}Next Steps:${NC}"
echo -e "1. Run ${YELLOW}./install-dependencies.sh${NC} to install project dependencies"
