      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.descriptionText}>
            Our educational content library is under development.
            Access science-based information about supplements, nutrition, and health optimization.
          </Text>
        </View>
        ...
        <View style={styles.featureCard}>
          ...
          <View style={styles.featureItem}>
            <Text style={styles.featureText}>• Educational articles</Text>
          </View>
          <View style={styles.featureItem}>
            <Text style={styles.featureText}>• Video tutorials</Text>
          </View>
          <View style={styles.featureItem}>
            <Text style={styles.featureText}>• Research summaries</Text>
          </View>
          <View style={styles.featureItem}>
            <Text style={styles.featureText}>• Expert interviews</Text>
          </View>
          <View style={styles.featureItem}>
            <Text style={styles.featureText}>• Interactive learning modules</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
