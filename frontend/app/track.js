      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.descriptionText}>
            Our supplement tracking system is under development.
            Monitor your supplement intake, set reminders, and track your progress and results.
          </Text>
        </View>
        ...
        <View style={styles.featureCard}>
          ...
          <View style={styles.featureItem}>
            <Text style={styles.featureText}>• Supplement intake logging</Text>
          </View>
          <View style={styles.featureItem}>
          ...
          <View style={styles.featureItem}>
            <Text style={styles.featureText}>• Supplement effectiveness ratings</Text>
          </View>
          <View style={styles.featureItem}>
            <Text style={styles.featureText}>• Regimen optimization</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
